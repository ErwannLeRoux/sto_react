...
function validateAndroidChannel(channel) {
     ...
     * badge
     */
    if (utils_1.hasOwnProperty(channel, 'badge')) {
     ...
     * bypassDnd
     */
    if (utils_1.hasOwnProperty(channel, 'bypassDnd')) {
     ...
     * description
     */
    if (utils_1.hasOwnProperty(channel, 'description')) {
     ...
     * lights
     */
    if (utils_1.hasOwnProperty(channel, 'lights')) {
     ...
     * vibration
     */
    if (utils_1.hasOwnProperty(channel, 'vibration')) {
     ...
     * groupId
     */
    if (utils_1.hasOwnProperty(channel, 'groupId')) {
     ...
     * importance
     */
    if (utils_1.hasOwnProperty(channel, 'importance') && channel.importance != undefined) {
     ...
     * lightColor
     */
    if (utils_1.hasOwnProperty(channel, 'lightColor') && channel.lightColor != undefined) {
     ...
     * visibility
     */
    if (utils_1.hasOwnProperty(channel, 'visibility') && channel.visibility != undefined) {
        if (!Object.values(NotificationAndroid_1.AndroidVisibility).includes(channel.visibility)) {
     ...
     * sound
     */
    if (utils_1.hasOwnProperty(channel, 'sound') && channel.sound != undefined) {
     ...
     * vibrationPattern
     */
    if (utils_1.hasOwnProperty(channel, 'vibrationPattern') && channel.vibrationPattern != undefined) {
