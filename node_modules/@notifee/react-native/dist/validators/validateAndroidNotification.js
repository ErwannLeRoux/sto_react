...
function validateAndroidNotification(android) {
    ...
    const out = {
        ...
        badgeIconType: NotificationAndroid_1.AndroidBadgeIconType.LARGE,
        colorized: false,
        chronometerDirection: 'up',
        defaults: [NotificationAndroid_1.AndroidDefaults.ALL],
        groupAlertBehavior: NotificationAndroid_1.AndroidGroupAlertBehavior.ALL,
        groupSummary: false,
        localOnly: false,
        ongoing: false,
        onlyAlertOnce: false,
        ...
        visibility: NotificationAndroid_1.AndroidVisibility.PRIVATE,
    };
     ...
     * actions
     */
    if (utils_1.hasOwnProperty(android, 'actions') && android.actions != undefined) {
     ...
     * asForegroundService
     */
    if (utils_1.hasOwnProperty(android, 'asForegroundService')) {
     ...
     * autoCancel
     */
    if (utils_1.hasOwnProperty(android, 'autoCancel')) {
     ...
     * badgeCount
     */
    if (utils_1.hasOwnProperty(android, 'badgeCount')) {
     ...
     * badgeIconType
     */
    if (utils_1.hasOwnProperty(android, 'badgeIconType') && !utils_1.isUndefined(android.badgeIconType)) {
        if (!Object.values(NotificationAndroid_1.AndroidBadgeIconType).includes(android.badgeIconType)) {
     ...
     * category
     */
    if (utils_1.hasOwnProperty(android, 'category') && !utils_1.isUndefined(android.category)) {
        if (!Object.values(NotificationAndroid_1.AndroidCategory).includes(android.category)) {
     ...
     * color
     */
    if (utils_1.hasOwnProperty(android, 'color') && !utils_1.isUndefined(android.color)) {
     ...
     * colorized
     */
    if (utils_1.hasOwnProperty(android, 'colorized')) {
     ...
     */
    if (utils_1.hasOwnProperty(android, 'chronometerDirection')) {
     ...
     * defaults
     */
    if (utils_1.hasOwnProperty(android, 'defaults') && !utils_1.isUndefined(android.defaults)) {
        ...
        const defaults = Object.values(NotificationAndroid_1.AndroidDefaults);
     ...
     * groupId
     */
    if (utils_1.hasOwnProperty(android, 'groupId')) {
     ...
     * groupAlertBehavior
     */
    if (utils_1.hasOwnProperty(android, 'groupAlertBehavior') && !utils_1.isUndefined(android.groupAlertBehavior)) {
        if (!Object.values(NotificationAndroid_1.AndroidGroupAlertBehavior).includes(android.groupAlertBehavior)) {
     ...
     * groupSummary
     */
    if (utils_1.hasOwnProperty(android, 'groupSummary')) {
    ...
    if (utils_1.hasOwnProperty(android, 'inputHistory')) {
     ...
     * largeIcon
     */
    if (utils_1.hasOwnProperty(android, 'largeIcon')) {
        if (!utils_1.isString(android.largeIcon) || !android.largeIcon) {
     ...
     * lights
     */
    if (utils_1.hasOwnProperty(android, 'lights') && !utils_1.isUndefined(android.lights)) {
     ...
     * localOnly
     */
    if (utils_1.hasOwnProperty(android, 'localOnly')) {
     ...
     * ongoing
     */
    if (utils_1.hasOwnProperty(android, 'ongoing')) {
     ...
     * onlyAlertOnce
     */
    if (utils_1.hasOwnProperty(android, 'onlyAlertOnce')) {
     ...
     * pressAction
     */
    if (utils_1.hasOwnProperty(android, 'pressAction') && !utils_1.isUndefined(android.pressAction)) {
        try {
     ...
     * importance
     */
    if (utils_1.hasOwnProperty(android, 'importance') && !utils_1.isUndefined(android.importance)) {
     ...
     * progress
     */
    if (utils_1.hasOwnProperty(android, 'progress') && !utils_1.isUndefined(android.progress)) {
        ...
        if (utils_1.hasOwnProperty(android.progress, 'indeterminate')) {
     ...
     * showTimestamp
     */
    if (utils_1.hasOwnProperty(android, 'showTimestamp')) {
     ...
     * smallIcon
     */
    if (utils_1.hasOwnProperty(android, 'smallIcon') && !utils_1.isUndefined(android.smallIcon)) {
     ...
     * smallIconLevel
     */
    if (utils_1.hasOwnProperty(android, 'smallIconLevel') && !utils_1.isUndefined(android.smallIcon)) {
     ...
     * sortKey
     */
    if (utils_1.hasOwnProperty(android, 'sortKey')) {
     ...
     * style
     */
    if (utils_1.hasOwnProperty(android, 'style') && !utils_1.isUndefined(android.style)) {
     ...
     * tag
     */
    if (utils_1.hasOwnProperty(android, 'tag') && android.tag != undefined) {
     ...
     * ticker
     */
    if (utils_1.hasOwnProperty(android, 'ticker')) {
     ...
     * timeoutAfter
     */
    if (utils_1.hasOwnProperty(android, 'timeoutAfter') && android.timeoutAfter != undefined) {
     ...
     * showChronometer
     */
    if (utils_1.hasOwnProperty(android, 'showChronometer')) {
     ...
     * vibrationPattern
     */
    if (utils_1.hasOwnProperty(android, 'vibrationPattern') && android.vibrationPattern != undefined) {
     ...
     * visibility
     */
    if (utils_1.hasOwnProperty(android, 'visibility') && android.visibility != undefined) {
        if (!Object.values(NotificationAndroid_1.AndroidVisibility).includes(android.visibility)) {
     ...
     * timestamp
     */
    if (utils_1.hasOwnProperty(android, 'timestamp') && android.timestamp != undefined) {
        ...
        if (!validate_1.isValidTimestamp(android.timestamp)) {
            throw new Error("'notification.android.timestamp' invalid millisecond timestamp, date must be in the future.");
        }
     ...
     * sound
     */
    if (utils_1.hasOwnProperty(android, 'sound') && android.sound != undefined) {
