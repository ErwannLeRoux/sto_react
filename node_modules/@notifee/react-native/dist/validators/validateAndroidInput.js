...
function validateAndroidInput(input) {
    ...
    if (utils_1.hasOwnProperty(input, 'allowFreeFormInput')) {
    ...
    if (utils_1.hasOwnProperty(input, 'allowGeneratedReplies')) {
    ...
    if (utils_1.hasOwnProperty(input, 'choices')) {
    ...
    if (utils_1.hasOwnProperty(input, 'editableChoices')) {
    ...
    if (utils_1.hasOwnProperty(input, 'placeholder')) {
